...
\begin{textblock*}{20.0cm}(2.0cm,1.0cm) % {block width} (coords)
	\includegraphics[height=4cm]{elektrobit_logo}
\end{textblock*}

\begin{textblock*}{20.0cm}(23.0cm,1.0cm) % {block width} (coords)
...
\vspace*{3.0cm}
\flushright{\Huge\sffamily\bfseries {Hazard Analysis}}
...
\begin{center}
\includegraphics[width=10cm]{title_page_figure}
\end{center}
